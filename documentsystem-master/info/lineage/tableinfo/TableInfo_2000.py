...
class TableInfo_2000(TableInfoBasic):
    ...
    def getBUReport2001Info(self, makeInfo):
        ...
        columnInfoMap["uniqueint_1"] = {"description": "gender", "hidden": "false", "datatype": "integer", "memo": "gender"}
        columnInfoMap["uniqueint_2"] = {"description": "skin", "hidden": "false", "datatype": "integer", "memo": "skin"}
        columnInfoMap["uniqueint_3"] = {"description": "face", "hidden": "false", "datatype": "integer", "memo": "face"}
        columnInfoMap["uniqueint_4"] = {"description": "hair", "hidden": "false", "datatype": "integer", "memo": "hair"}
        columnInfoMap["uniqueint_5"] = {"description": "job", "hidden": "false", "datatype": "integer", "memo": "job"}
        columnInfoMap["uniqueint_6"] = {"description": "mapid", "hidden": "false", "datatype": "integer", "memo": "mapid"}
