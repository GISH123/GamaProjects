...
class TableInfo_5100(TableInfoBasic):
    ...
    def getBUReport5101Info(self, makeInfo):
        ...
        columnInfoMap["uniqueint_1"] = {"description": "公會成員數量", "hidden": "false", "datatype": "integer", "memo": ""}
        columnInfoMap["uniqueint_2"] = {"description": "成員昨日登入數量", "hidden": "false", "datatype": "integer", "memo": ""}
