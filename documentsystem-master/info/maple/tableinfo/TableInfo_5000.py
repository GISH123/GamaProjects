...
class TableInfo_5000(TableInfoBasic):
    ...
    def getBUReport5001Info(self, makeInfo):
        ...
        columnInfoMap["uniqueint_1"] = {"description": "好友數量", "hidden": "false", "datatype": "integer", "memo": ""}
        columnInfoMap["uniqueint_2"] = {"description": "好友昨日登入數量", "hidden": "false", "datatype": "integer", "memo": ""}
