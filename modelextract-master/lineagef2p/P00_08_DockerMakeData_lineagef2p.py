...
def makeSSHStrArr(makeInfo):
    ...
    sshStrsInit = """docker exec -it [:DockerName] python3 /Data/DockerMakeModelExtract_[:GameName]/[:GameName]/P00_01_Run_lineagef2p.py [:Parameter] """.replace("[:DockerName]", dockerName)
...
if __name__ == "__main__":
    ...
    # main({"dateRangeArr": [['2020-01-01', '2020-01-02']], "gamename": ["lineagef2p"], "tableNumberArr": ["1001", "1002"]})
