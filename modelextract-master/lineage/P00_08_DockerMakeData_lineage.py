...
def main(parametersData={}):
    ...
    gameNameArr = ["lineage"] if gameNameArr == [] else gameNameArr
...
def makeSSHStrArr(makeInfo):
    ...
    sshStrsInit = """docker exec -it [:DockerName] python3 /Data/DockerMakeModelExtract_[:GameName]/[:GameName]/P00_01_Run_lineage.py [:Parameter] """.replace("[:DockerName]", dockerName)
...
if __name__ == "__main__":
    ...
    # main()
    main({"makedate": ["2021-11-18"]})
    # main({"makedate": ["2020-01-01"], "gamename": ["lineage"], "tableNumberArr": ["1001", "1002"]})
    # main({"dateRangeArr": [['2020-01-01', '2020-01-02']], "gamename": ["lineage"], "tableNumberArr": ["1001", "1002"]})
