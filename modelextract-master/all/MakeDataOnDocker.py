...
def main(parametersData={}):
    ...
    gameNameArr = ["lineageglobal", "lineage", "lineagef2p"] if gameNameArr == [] else gameNameArr
...
def makeSSHStrArr(makeInfo):
    ...
    sshStrsInit = """docker exec -it [:DockerName] python3 /Data/DockerMakeModelExtract_[:GameName]/[:GameName]/P21_01_MakeModelExtract.py [:Parameter] """.replace("[:DockerName]", dockerName)
...
if __name__ == "__main__":
    ...
    # main({"dateRangeArr": [['2020-01-01', '2020-01-02']], "gamename": ["lineageglobal"], "tableNumberArr": ["1001", "1002"]})
    # main({"startdate": ["2021-01-03"], "enddate": ["2021-01-04"], "gamename": ["lineageglobal"], "tableNumberArr": ["1001", "1002"]})
