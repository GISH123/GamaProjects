...
from sql.wod.modelextract.ReportInfo import ReportInfo
...
def main(parametersData = {}):
    ...
    for makeTime in makeTimeArr:
        ...
        if makeTime <= datetime.datetime(2021, 1, 14, 0, 0, 0, 0) and worldNameArr == reportInfo.worldNameArr:
            worldNameArr_make = ["101", "102", "103", "104", "1011"]
        elif makeTime <= datetime.datetime(2021, 2, 4, 0, 0, 0, 0) and worldNameArr == reportInfo.worldNameArr:
            worldNameArr_make = ["101", "102", "103", "104", "105", "1011"]
        elif makeTime <= datetime.datetime(2021, 4, 26, 0, 0, 0, 0) and worldNameArr == reportInfo.worldNameArr:
            worldNameArr_make = ["101", "102", "103", "104", "105", "106", "1011"]
        makeInfo = {
            "makeTime": makeTime
            , "gameName": gameName
