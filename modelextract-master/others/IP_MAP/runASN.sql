DROP TABLE IF EXISTS gtwpd.temp_asn;
CREATE EXTERNAL TABLE gtwpd.temp_asn
(
   	ip_from bigint
	, ip_end bigint
	, c_idr	string
...
LOCATION '/user/GTW_PD/DB/TEMP/temp_ipmap/asp/';
WITH tb AS
(
SELECT
   	ip_from
...
INSERT OVERWRITE TABLE gtwpd.modelextract_modelextract PARTITION(game='COMMON',dt='[:DateNoLine]',world='COMMON',tablenumber='11852')
SELECT
