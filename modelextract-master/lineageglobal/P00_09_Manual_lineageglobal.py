...
import lineageglobal.P21_01_MakeModelExtract as makeModelExtractCtrl
...
if __name__ == "__main__":
    ...
    # main()
    # main({"makedate": ["2021-06-18", "2020-12-23"]})
    # main({"makedate": ["2021-01-01"], "tableNumberArr": ["11001", "11005", "1003"]})
    # main({"dateRangeArr": [['2021-01-01', '2021-01-31'], ['2021-02-01', '2021-02-28'], ['2021-03-01', '2021-03-31']]})
    # main({"startdate": ["2021-01-02"], "enddate": ["2021-03-21"]})
    main({"startdate": ["2021-01-02"], "enddate": ["2021-07-17"], "tableNumberArr": ["11001", "11005", "1003"]})
