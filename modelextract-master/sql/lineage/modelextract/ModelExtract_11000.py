    ...
    def insert11001DataSQL(self, makeInfo):
        fromSQLCode = """
            ...
            FROM (
                ...
                FROM (
                    SELECT actor_account_name
                    ,CASE WHEN actor_world <= 40 THEN (actor_world - 1) ELSE actor_world END AS actor_world
                    ,actor_id,actor_name,actor_class,actor_level,
                ...
                ON a.actor_account_name = d.real_account AND a.actor_id = d.uid AND cast(a.actor_world as int) = cast(d.world as int)
    ...
    def insert11002DataSQL(self, makeInfo):
        fromSQLCode = """
            ...
            FROM (
                ...
                FROM(  
                    SELECT a.actor_account_name
                    ,CASE WHEN a.actor_world <= 40 THEN (a.actor_world - 1) ELSE a.actor_world END AS actor_world
        ...
        fromSQLCode = """
            ...
            FROM (
                ...
                FROM ( 
                    SELECT actor_account_name
                    ,CASE WHEN actor_world <= 40 THEN (actor_world - 1) ELSE actor_world END AS actor_world
                    ,actor_id,actor_name,actor_class,actor_level,logid,acttime,
                ...
                ON a.actor_account_name = d.real_account AND a.actor_name = d.user_id AND cast(a.actor_world as int) = cast(d.world as int)
                WHERE logid = 1004	
