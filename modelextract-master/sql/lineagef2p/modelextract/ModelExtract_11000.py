    ...
    def insert11001DataSQL(self, makeInfo):
        fromSQLCode = """
            ...
            FROM (
                ...
                ON a.actor_account_name = d.real_account AND a.actor_id = d.uid AND cast(a.actor_world as int) = (cast(d.world as int)+100)
    ...
    def insert11005DataSQL(self, makeInfo):
        fromSQLCode = """
            ...
            FROM (
                ...
                ON a.actor_account_name = d.real_account AND a.actor_name = d.user_id AND cast(a.actor_world as int) = (cast(d.world as int)+100)
                WHERE logid = 1004	
