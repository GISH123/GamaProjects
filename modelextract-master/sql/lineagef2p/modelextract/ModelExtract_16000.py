...
class ModelExtract_16000 :
    ...
    def insert16001DataSQL(self, makeInfo):
        fromSQLCode = """
            ...
            FROM (
                SELECT actor_account_name AS CommonData_1
                ...
                FROM (
                    SELECT actor_account_name,pg_goods_nm,'TWD' AS currency_nm,cash_twd,buy_qty,buymon
                    FROM rcenter.gama_scheduler_AccInGameCash
                    WHERE plogdate = '[:DateNoLine]'
                    UNION ALL
                    SELECT actor_account_name,pg_goods_nm,'GASH' AS currency_nm,cash_twd,buy_qty,buymon
                    FROM rcenter.gama_scheduler_AccCouponCash
                    WHERE plogdate = '[:DateNoLine]'
                ) a
                GROUP BY actor_account_name,pg_goods_nm,currency_nm,buymon
            ) tmp """
        mutiInsertSQLCode = """
    ...
    def insert16509DataSQL(self, makeInfo):
        fromSQLCode = """
            ...
            FROM (
                SELECT AA.actor_account_name,AA.actor_world,AA.actor_id,AA.actor_name,BB.class_tw_nm AS actor_class,AA.actor_level
                ...
                LEFT OUTER JOIN (
                    SELECT actor_account_name as target_account_id,actor_world as target_world,actor_id as target_id
        ...
        mutiInsertSQLCode = """ 
            ...
            SELECT actor_account_name AS CommonData_1, actor_world AS CommonData_2, actor_id AS CommonData_3
