...
class ModelExtract_1100(ModelExtract_1100_Common) :
    ...
    def insert1101DataSQL(self, makeInfo):
        ...
        mutiInsertSQLCode = """ 
            ...
            PARTITION(game='[:GameName]',dt='[:DateNoLine]',world='COMMON',tablenumber='1101')
    ...
    def insert1102DataSQL(self, makeInfo):
        fromSQLCode = """
            ...
            FROM(
                SELECT a.CommonData_1,c.externalaccountkey AS CommonData_6,c.authprovidercode AS CommonData_10
                ,a.UniqueTime_1,a.UniqueTime_2,a.world
                FROM rcenter.gama_bda_model_extract a
                LEFT OUTER JOIN np.np_gameaccounts b
                ON a.CommonData_1 = b.gameaccountid 
                LEFT OUTER JOIN np.np_externalassociations c
    ...
    def insert1132DataSQL(self, makeInfo):
        fromSQLCode = """
            ...
            FROM(
                SELECT AA.CommonData_1, AA.CommonData_3, AA.CommonData_4, AA.CommonData_6
                , SUM(CASE 
                ...
                GROUP BY AA.commondata_1, AA.commondata_3, AA.commondata_4, AA.commondata_6, AA.world
            ) tmp """
        mutiInsertSQLCode = """
            INSERT OVERWRITE TABLE rcenter.gama_bda_model_extract 
