...
if __name__ == "__main__":
    ...
    startDateTime = datetime.datetime.strptime( "2022-05-01", "%Y-%m-%d")
    ...
    while makeDatetime <= endDateTime:
        makeModeling.main({
            ...
            , "project": ["P05DataCheckAlarmExample"]                             # 只能輸入計畫名 , 只會取第一個值
            , "modelversion": ["V0_0_4"]                                    # 只能輸入格式為V0_0_1 , 在 runtype 為 buildmodel 取單一值 , 在 runtype 為 runmodel 取多個
            #, "parameter": {"qweqwe": 1231231231232}
        })
