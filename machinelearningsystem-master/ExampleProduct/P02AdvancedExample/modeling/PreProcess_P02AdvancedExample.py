...
class PreProcess_P02AdvancedExample() :

    @classmethod
    def MakePreProcess_P02AdvancedExample_P1_0_1(self, makeInfo):
        """
        MakePreProcessCtrl 方法說明
            會撈取 return preprocessType, preprocessObject 的 preprocessType, preprocessObject 找到相關的檔案
            例如 preprocessType , preprocessObject 就會撈取 ExampleProduct\P02AdvancedExample\file\ctrl\ExampleProduct_{preprocessObject}_PreProcessCtrl.csv
        PreProcessCtrl 欄位說明
            new_col
            origin_col
            negtive
            ...
            description
        """
        return "MakePreProcessCtrl", "P02AdvancedExample_P1_0_1" , {"DataCount":21123}

    @classmethod
    def MakePreProcess_P02AdvancedExample_P1_0_2(self, makeInfo):
        """
        ...
        JOIN maintable2 ; 
                """
        return "MakePreProcessOrderSQLInsert", [orderSQL1] , {"DataCount":21123}

    @classmethod
    def MakePreProcess_P02AdvancedExample_P1_0_3(self, makeInfo):
        """
        MakePreProcessFileInsert 方法說明
            ...
            像是該Function 就會上傳到/user/GTW_PD/DB/Model/Usedata/product=ExampleProduct/project=P02AdvancedExample/version=P1_0_3/dt=20211231/step=PreProcess
        """
    ...
    @classmethod
    def MakePreProcess_P02AdvancedExample_P1_0_4(self, makeInfo):
        """
        ...
        # 自由發揮
        usedataDF = pandas.read_csv("ExampleProduct/P02AdvancedExample/file/data/ExampleProduct_P02AdvancedExample_P1_0_4_20211231_rawdata_noallcolumn.csv", sep="\t")
        ...
        return "MakePreProcessFreeFuction", None , {"DataCount":21123}
