...
class RawData_P02AdvancedExample() :

    @classmethod
    def MakeRawData_P02AdvancedExample_R1_0_1(self, makeInfo):
        """
        return "MakeRawDataCtrl", "P02AdvancedExample_R1_0_1" , {"DataCount":21123}
        MakeRawDataCtrl 方法說明
            會撈取 return rawDataType , rawDataObject 的 rawDataType , rawDataObject 找到相關的檔案
            例如 rawDataType , rawDataObject 就會撈取 ExampleProduct\P02AdvancedExample\file\ctrl\ExampleProduct_{rawDataObject}_RawDataCtrl.csv
        RawDataCtrl 欄位說明
            origin_table    資料基本位置 主要是指正規區
            tablenumber     使用到的tablenumber編號
            origin_col      使用到的origin_col欄位
            func            使用的方法 common groupby SUM
            conditions
            then_value
            else_value
            new_name
    ...
    @classmethod
    def MakeRawData_P02AdvancedExample_R1_0_2(self, makeInfo):
        """
        return "MakeRawDataOrderSQLInsert", [orderSQL1] , {"DataCount":21123}
        MakeRawDataOrderSQLInsert 方法說明
            會撈取 return rawDataType , rawDataObject 的 rawDataObject 裡面放置SQL陣列
            就會將 rawDataObject 裡的SQL陣列丟置HIVE執行
        相關可輸入參數
        ...
        orderSQL1 = """
          ...
          GROUP BY 
              ...
              , commondata_9 ;
                  """
        orderSQL1 = ""
        makeInfo["result"] = "qeqweqweqweqeqweqweqwewqew"
        return "MakeRawDataOrderSQLInsert", [orderSQL1] , {"DataCount":21123}

    @classmethod
    def MakeRawData_P02AdvancedExample_R1_0_3(self, makeInfo):
        """
        ...
        MakeRawDataFileInsert 方法說明
            ...
            像是該Function 就會上傳到/user/GTW_PD/DB/Model/Usedata/product=ExampleProduct/project=P02AdvancedExample/step=RawData/version=R1_0_3/dt=20211231
        """
        from package.common.common.RawPreModel import RawPreModel
        sql_str = '''
                SELECT 
                    commondata001, commondata002
        ...
        # or
        df = pandas.read_csv("ExampleProduct/P02AdvancedExample/file/data/ExampleProduct_P02AdvancedExample_R1_0_3_20211231_rawdata_noallcolumn.csv", sep="\t")
        return "MakeRawDataFileInsertOverwrite", df , {"DataCount":21123}

    @classmethod
    def MakeRawData_P02AdvancedExample_R1_0_4(self, makeInfo):
        """
        return "MakeRawDataFreeFuction", None , {"DataCount":21123}
        MakeRawDataFreeFuction
        ...
        # 自由發揮
        usedataDF = pandas.read_csv("ExampleProduct/P02AdvancedExample/file/data/ExampleProduct_P02AdvancedExample_R1_0_4_20211231_rawdata_noallcolumn.csv", sep="\t")
