...
class UseModel_CheckProject() :

    @classmethod
    def MakeUseModel_CheckProject_M1_0_2(self, makeInfo):
        """
        ...
        orderSQL1 = """
              ...
              ) INSERT OVERWRITE TABLE gtwpd.model_usedata PARTITION ( product = 'ExampleProduct' , project = 'CheckProject' , step = 'UseModel', version = 'M1_0_2' , dt = '[:DateNoLine]'  )
              SELECT 
    ...
    @classmethod
    def MakeUseModel_CheckProject_M1_0_3(self, makeInfo):
        """
        MakeUseModelFileInsert 方法說明
            ...
            像是該Function 就會上傳到/user/GTW_PD/DB/Model/Usedata/product=ExampleProduct/project=CheckProject/version=M1_0_3/dt=20211231/step=UseModel
        """
        df = pandas.read_csv("ExampleProduct/CheckProject/file/data/ExampleProduct_CheckProject_P1_0_3_20211231_rawdata_noallcolumn.csv", sep="\t")
        """
        # 模型建立............
        #
        #
        ...
        modelResultDF = df
        modelScoreDF = df
        return "MakeUseModelFileInsert", [modelResultDF,modelScoreDF]

    @classmethod
    def MakeUseModel_CheckProject_M1_0_4(self, makeInfo):
        """
        ...
        # 自由發揮
        df = pandas.read_csv("ExampleProduct/CheckProject/file/data/ExampleProduct_CheckProject_P1_0_4_20211231_rawdata_noallcolumn.csv", sep="\t")
        """
        # 模型建立............
        #
        #
    ...
    @classmethod
    def MakeUseModel_CheckProject_M1_0_7(self, makeInfo):
        return "MakeUseModelFreeFuction", None
