...
class RawData_CheckProject() :

    @classmethod
    def MakeRawData_CheckProject_R1_0_1(self, makeInfo):
        """
        MakeRawDataCtrl 方法說明
            會撈取 return rawDataType , rawDataObject 的 rawDataType , rawDataObject 找到相關的檔案
            例如 rawDataType , rawDataObject 就會撈取 ExampleProduct\CheckProject\file\ctrl\ExampleProduct_{rawDataObject}_RawDataCtrl.csv
        RawDataCtrl 欄位說明
            ...
            description
        """
        return "MakeRawDataCtrl", "CheckProject_R1_0_1"

    @classmethod
    def MakeRawData_CheckProject_R1_0_2(self, makeInfo):
        """
        ...
        orderSQL1 = """
          ...
          GROUP BY 
              ...
              , commondata_9 ;
                  """
        return "MakeRawDataOrderSQLInsert", [orderSQL1]

    @classmethod
    def MakeRawData_CheckProject_R1_0_3(self, makeInfo):
        """
        ...
        """
        df = pandas.read_csv("ExampleProduct/CheckProject/file/data/ExampleProduct_CheckProject_R1_0_3_20211231_rawdata_noallcolumn.csv", sep="\t")
        return "MakeRawDataFileInsert", df

    @classmethod
    def MakeRawData_CheckProject_R1_0_4(self, makeInfo):
        """
        ...
        # 自由發揮
        df = pandas.read_csv(
            "ExampleProduct/CheckProject/file/data/ExampleProduct_P02AdvancedExample_P1_0_4_20211231_rawdata_noallcolumn.csv",
            sep="\t")
        """
        # 模型建立............
        #
        ...
        for insertInfos in insertInfoArr:
            ...
            df.to_csv("{}/{}/file/HDFSUploadTempFile/{}".format(productName, project, hdfsFile), sep="\t", index=None,
                      header=None)
            hdfsCtrl.deleteDirs(hdfsPath)
            hdfsCtrl.upload(hdfsPath + "/" + hdfsFile,
                            "{}/{}/file/HDFSUploadTempFile/{}".format(productName, project, hdfsFile))
    ...
    @classmethod
    def MakeRawData_CheckProject_R1_0_7(self, makeInfo):
        return "MakeRawDataFreeFuction", None
