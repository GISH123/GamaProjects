...
def main(parametersData = {}):
    ...
    if dataBaseArr == [] and gameWorldArr == []:
        ...
        gameWorldArr = [
            ...
            ["01", "LINWORLD1", "linworld", "2099-12-31"]
            , ["02", "LINWORLD2", "linworld", "2099-12-31"]
            , ["03", "LINWORLD3", "linworld", "2099-12-31"]
            , ["05", "LINWORLD5", "linworld", "2099-12-31"]
            , ["39", "LINWORLD39", "linworld", "2099-12-31"]
            ]
