...
def main(parametersData = {}, checkCreate = True):
    ...
    dataBaseArr1 = ["LinDB"] if dataBaseArr == [] and gameWorldArr == [] else dataBaseArr
    gameWorldArr = [
        # [伺服器線編號, DBName, 關閉時間]
        ["01", "LINWORLD1", "2099-12-31"]
        , ["02", "LINWORLD2", "2099-12-31"]
        , ["03", "LINWORLD3", "2099-12-31"]
        , ["05", "LINWORLD5", "2099-12-31"]
        , ["39", "LINWORLD39", "2099-12-31"]
    ...
    databaseInfo = {
        ...
        # 建World DB使用
        , "worldSchmeaNameInit": "lineage_all.linworld_"
