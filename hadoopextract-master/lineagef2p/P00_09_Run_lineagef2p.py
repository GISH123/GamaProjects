...
import lineagef2p.P10_MakeTableAndPartition as makeTableAndPartition
import lineagef2p.P20_MakeInitExtract as makeInitExtract
import lineagef2p.P21_MakeExtract as makeExtract
import lineagef2p.P50_MakeALLMonthFirst as makeALLMonthFirst
...
def mainALLData(makeInfo):
    ...
    if runMakeTableAndPartition == True:
        ...
        print('RUN LineageF2P MakeTableAndPartition')
    ...
    if runMakeInitExtract == True:
        print('RUN LineageF2P MakeInitExtract')
    ...
    if runMakeExtract == True:
        print('RUN LineageF2P MakeExtract')
    ...
    if runMakeALLMonthFirst == True:
        print('RUN LineageF2P MakeALLMonthFirst')
