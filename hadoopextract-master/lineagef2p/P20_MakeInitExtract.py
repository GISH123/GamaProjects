...
def main(parametersData = {}):
    ...
    tableNameArr = ["lineagef2p_onliontimebyaccount", "lineagef2p_onliontimebycharacter"] if tableNameArr == [] else tableNameArr
    tableInfoArr = [
        # ["ExtractTable, SourceTable, ColumnsType, Columns, LoginTimeColumnName, LogoutTimeColumnName]
        ["lineagef2p_onliontimebyaccount", "lindbf2p_user_account"
            , "lastlogin timestamp, lastlogout timestamp, account string"
            , "lastlogin, lastlogout, account", "lastlogin", "lastlogout"]
        , ["lineagef2p_onliontimebycharacter", "linworld_f2p_user_town"
