...
import lineageglobal.P10_MakeTableAndPartition as makeTableAndPartition
import lineageglobal.P20_MakeInitExtract as makeInitExtract
import lineageglobal.P21_MakeExtract as makeExtract
import lineageglobal.P50_MakeALLMonthFirst as makeALLMonthFirst
...
def mainALLData(makeInfo):
    ...
    if runMakeTableAndPartition == True:
        ...
        print('RUN LineageGlobal MakeTableAndPartition')
        makeTableAndPartition.main(parametersDataSource, checkCreate)
    ####################################################################################################
    """
    MakeInitExtract
    """
    if runMakeInitExtract == True:
        print('RUN LineageGlobal MakeInitExtract')
    ...
    if runMakeExtract == True:
        print('RUN LineageGlobal MakeExtract')
    ...
    if runMakeALLMonthFirst == True:
        print('RUN LineageGlobal MakeALLMonthFirst')
