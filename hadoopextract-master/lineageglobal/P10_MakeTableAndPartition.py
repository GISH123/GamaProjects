...
def main(parametersData = {}, checkCreate = True):
    ...
    dataBaseArr1 = ["LinDBGlobal"] if dataBaseArr == [] and gameWorldArr == [] else dataBaseArr
    gameWorldArr = [
        # [伺服器線編號, DBName, 關閉時間]
        ["01", "LINWORLD1_Global", "2099-12-31"]
        , ["02", "LINWORLD2_Global", "2021-02-19"]
        , ["04", "LINWORLD4_Global", "2099-12-31"]
        , ["05", "LINWORLD5_Global", "2021-02-19"]
        , ["06", "LINWORLD6_Global", "2021-02-19"]
        , ["07", "LINWORLD7_Global", "2021-02-19"]
    ...
    databaseInfo = {
        ...
        # 建World DB使用
        , "worldSchmeaNameInit": "lineage_all.linworld_global_"
