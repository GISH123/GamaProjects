...
def main(parametersData = {}):
    ...
    if dataBaseArr == [] and gameWorldArr == []:
        dataBaseArr = ["LinDBGlobal"]
        gameWorldArr = [
            # [伺服器線編號, DBName, 中繼區TableName, 關閉時間]
            ["01", "LINWORLD1_Global", "linworld_global", "2099-12-31"]
            , ["02", "LINWORLD2_Global", "linworld_global", "2021-02-19"]
            , ["04", "LINWORLD4_Global", "linworld_global", "2099-12-31"]
            , ["05", "LINWORLD5_Global", "linworld_global", "2021-02-19"]
            , ["06", "LINWORLD6_Global", "linworld_global", "2021-02-19"]
            , ["07", "LINWORLD7_Global", "linworld_global", "2021-02-19"]
            ]
