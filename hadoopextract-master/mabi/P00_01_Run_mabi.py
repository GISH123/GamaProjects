...
import mabi.P02_01_DataSize as dataSizeCtrl
import mabi.P02_02_DataCheck as dataCheckCtrl
import mabi.P02_10_MakeTableAndPartition as makeTableAndPartitionCtrl
import mabi.P02_11_CheckImportDataSize as CheckImportDataSizeCtrl
import mabi.P11_00_MakeInitExtract as makeInitExtractCtrl
import mabi.P11_10_MakeALL as makeALLCtrl
import mabi.P11_11_MakeALLMonthFirst as makeALLMonthFirstCtrl
...
def mainALLData(makeTimeStr = ""):
    ...
    runDataSize = True
    runDataCheck = True
    runCheckImportDataSizeCtrl = True
    runMakeTableAndPartition = True
    runMakeInitExtract = True
    runMakeALL = True
    runMakeALLMonthFirst = True
    ####################################################################################################
    if False == True:
...
if __name__ == "__main__" :
    nowTime = datetime.datetime.now()
    nowZeroTime = datetime.datetime(nowTime.year, nowTime.month, nowTime.day, 0, 0, 0, 0)
    makeDateStr = (nowZeroTime - datetime.timedelta(days=14)).strftime("%Y-%m-%d")
    main(makeDateStr)
