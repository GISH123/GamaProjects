...
def mainALLData(makeTimeStr = ""):
    ...
    if False == True :
        ...
        endDateStr = "2020-07-31"

        gameName = "els"
        hdfsDBName = "DB"
        hiveDBName = "DB"

        partitionRunAll = "False"                   # 02_10 階段 如何重作 ALL Partition
        partitionRunRestore = "True"                # 02_10 階段 如何重作 Restore Partition
        ...
        partitionMakeCodeArr = makeCodeArr          # 11_21 階段 如何建立建模前Partition
        ################################################################################################
        runDataSize = False  # 已完成
        runDataCheck = False  # 已完成
        runRestoreMakeSH = False # 已完成
        runRestoreMakeData = False # 已完成
        runMakeTableAndPartition = True
        runMakeInitExtract = True
        runMakeALL = True
    ####################################################################################################
