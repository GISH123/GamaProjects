...
def main(parametersData = {}):
    ...
    for makeTime in makeTimeArr:
        ...
        MakeInitDataMain(makeTime , tableNameArray)

def MakeInitDataMain(makeTime , tableNameArray):
    if tableNameArray == [] or "onliontime" in tableNameArray :
        databaseInfo = {
            "gameName": "tdn"
            , "dbName": "init"
    ...
    if tableNameArray == [] or "onliontimebyaccount" in tableNameArray :
        databaseInfo = {
            "gameName": "tdn"
            , "dbName": "init"
    ...
    if tableNameArray == [] or "onliontimebybf" in tableNameArray :
        databaseInfo = {
            "gameName": "tdn"
            , "dbName": "init"
