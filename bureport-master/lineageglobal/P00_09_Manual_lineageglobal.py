...
import lineageglobal.P31_01_MakeBUReport as makeBUReportCtrl
import lineageglobal.P35_MoveBUReport as moveBUReportCtrl
import lineageglobal.P36_01_MakeBUReportStatistics as makeBUReportStatisticsCtrl
# import lineageglobal.P36_02_MakeBUReport as makeBUReportExcelCtrl
...
if __name__ == "__main__":
    ...
    # 20210219併服 , "162", "165", "166", "167"
    # main()
    # main({"makedate": ["2021-03-22", "2021-02-25", "2021-01-23"]})
    # main({"makedate": ["2021-01-01"], "tableNumberArr": ["1003"]})
    # main({"dateRangeArr": [['2021-01-19', '2021-01-24']]})
