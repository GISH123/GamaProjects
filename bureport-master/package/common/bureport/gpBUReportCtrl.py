...
class GPBUReportCtrl:

    def MoveBUReportToGP(self, makeInfo):
        ...
        for layer in layerArr :
            for tableNumber in layerInfoArrMap[layer] :
                if tableNumber in tableNumberArr :
                    for interDependenceTableNumber in tableNumberInfoMap[tableNumber]["interDependence"] if tableNumber in tableNumberInfoMap.keys() else [] :
                    ...
                    try :
                        ...
                        if greenplumCtrl.checkTable(tableName):
                            ...
                            sqlCreateTableStr, sqlCreateIndexStr = self.getCreateTableReportSQL()
                        ...
                        # 撈取資料
                        sqlStr = self.getBusinessUnitReportSQL()
                        for sqlReplace in sqlReplaceArr:
    ...
    def MakeBUReportStatistics(self,makeInfo):
    ...
    def getBusinessUnitReportSQL(self):
        return """
        SELECT
    ...
    def getCreateTableReportSQL(self):
        return """
